...
@return AxiosPromise
**/
exports.PromptPay = function (obj, env) {
    ...
    var url = 'https://api.gbprimepay.com/gbp/gateway/qrcode';
    if (env == 'development') {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.post(url, qs.stringify(setData), config)];
                case 1:
                    data = (_a.sent()).data;
